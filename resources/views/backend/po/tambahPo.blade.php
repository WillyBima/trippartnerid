  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Form Tambah PO Bus</li>
      </ol>
    </section>
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            <div class="box-header with-border text-center">
              <h3 class="box-title">Form Tambah Data PO Bus</h3>
            </div>
            <form role="form" action="{{url('/MenuPo/tambahData')}}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="box-body">
