    	...
    	<div class="container py-lg-5 py-sm-4">
    		...
    		<div class="contact-grids">
                ...
                <div class="col-sm-6 form-group contact-forms">
                  <img src="{{url('img/bus/'.$databus->gambar_bus)}}" alt="" class="img-fluid abt-image" />
    						...
    						<div class="col-sm-6 form-group contact-forms">
                  <h5 class="text-center"><strong>Fasilitas Bus {{$databus->nama_bus}}</strong></h5>
                  <div class="row" style="margin-top: 15px;">
                    <div class="col-md-6">
                      @foreach($datafasilitasbus as $fasilitas)
                      <p style="font-family: Cambria; font-size: 17px; color: #25aae2; padding-left: 50px;">{{$fasilitas->nama_fasilitas}}</p>
                      @endforeach
                    </div>
                    <div class="col-md-6">
                      <p style="font-family: Cambria; font-size: 17px; color: #25aae2;">Harga Sudah Termasuk : </p>
                      <p style="font-family: Cambria; font-size: 17px; color: #25aae2;">Supir</p>
                      <p style="font-family: Cambria; font-size: 17px; color: #25aae2;">Bahan Bakar</p>
                    </div>
                  </div>
    						</div>
            ...
            <div class="col-lg-12 contact-left-form">
              <h5 class="mt-3 text-center"><strong>Data Pemesanan</strong></h5><br>
    					<form action="{{url('/detail-armada/submit-pesanan')}}" method="post" class="row text-center">
                {{ csrf_field() }}
                <div class="col-sm-6 form-group contact-forms">
                ...
                <div class="col-sm-6 form-group contact-forms">
    						  <input type="text" class="form-control" name="alamat_jemput" placeholder="Kota Asal" required="">
    						</div>
                <div class="col-sm-6 form-group contact-forms">
    						  <input type="text" class="form-control" name="alamat_tujuan" placeholder="Kota Tujuan" required="">
    						</div>
                <div class="col-sm-6 form-group contact-forms">
                ...
                <button class="btn btn-block sent-butnn" type="submit">Kirim Data Pemesanan</button>
    					</form>
    				</div>
    			</div>
    		</div>
